...
import com.dottyvinnie.portmod.items.block.ItemBlockPM;
...
public class PMBlock extends Block implements ModBlocks.ISubBlocksPM
{
	...
	public PMBlock(Material material, String... types)
    {
		super(material);
		this.types = types;
	}
